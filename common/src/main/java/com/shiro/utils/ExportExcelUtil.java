...
public class ExportExcelUtil {
	...
	public static void exportExcel(String rootPath, String title, String[] headers,
								   Collection<String[]> dataset, OutputStream out) {
		dataset.forEach(System.out::println);
		ExportExcelUtil.exportExcel(rootPath,title, headers, dataset, out, "yyyy-MM-dd");
	}
	...
	private static void exportExcel(String rootPath, String title, String[] headers,
